...
class PageChrome:
    ...
    def __call__(self, canvas, doc):
        ...
        canvas.drawString(MARGIN + 26, cy - 1, self.title)
        canvas.setFillColor(TEAL)
        ...
        canvas.drawString(MARGIN, 0.38 * inch, f"Generated by {BRAND} · {URL}")
        canvas.setFont("Helvetica", 6.5)
        canvas.setFillColor(FAINT)
        canvas.drawCentredString(w / 2, 0.38 * inch, "POWERED BY NGINEAGENT · CONFIDENTIAL")
